...
builder.Services.AddCors(option =>
{
    option.AddPolicy("allow_origin", policy =>
    {
        ...
        policy.WithOrigins("https://localhost:9999", "https://login.cybersoft.edu.vn", "http://127.0.0.1:9999")
...
builder.Services.AddScoped<EbayService>();
//DI service JWT
...
app.UseRouting(); //routing cua blz server
